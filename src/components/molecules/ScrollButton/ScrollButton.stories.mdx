...
<Meta title="Molecules | ScrollButton" component={ScrollButton} />
...
<Preview>
  <Story name="Basic" args={{
    ...
    {(args) => (
      ...
      <BlogPost
        id="root"
        coverImage="https://images.unsplash.com/photo-1593642634524-b40b5baae6bb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2089&q=80"
        date="2020-06-29"
        data={`<blockquote>
